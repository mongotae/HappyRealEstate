...
public class Apt2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        entries.add(new Entry(4,43500));
        entries.add(new Entry(5,42300));
        entries.add(new Entry(6,43300));
        entries.add(new Entry(7,37500));
        entries.add(new Entry(8,43250));
        entries.add(new Entry(9,42600));
        entries.add(new Entry(10,43000));
        entries.add(new Entry(11,43500));
        entries.add(new Entry(12,44000));
